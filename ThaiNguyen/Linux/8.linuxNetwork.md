...
## Using nmcli command
nmcli là trình quản lý mạng được điều khiển bằng giao diện dòng lệnh. Công dụng của nó bao gồm nhưng không giới hạn ở việc hiển thị trạng thái mạng, bật hoặc hiển thị mạng và xóa kết nối mạng.

```
nmcli [options] object {command|help}
```
Người dùng có thể chọn từ 8 phần để điền vào trường đối tượng.

|Đối tượng|Sử dụng|
|----|-----|
|general|lấy trạng thái và cấu hình chung của trình quản lý mạng|
|networking|bắt đầu, khởi động lại và quản lý trình quản lý mạng|
|radio| quản lý các giao thức và thiết bị không dây|
|connection|quản lý kết nối|
|device| quản lý thiết bị mạng|
|agent|định cấu hình và quản lý cài đặt bảo mật|
|monitor|giám sát thay đổi mạng|

Các tùy chọn phổ biến:
- -t: in đầu ra ở định dạng ngắn gọn
- -f [tên trường]: in đầu ra chỉ với các trường được chỉ định
- -p: in đầu ra ở định dạng có tổ chức, dễ đọc
