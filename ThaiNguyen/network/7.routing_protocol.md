...
When a router detects an unreachable route, it identifies the route in its routing table and sets the hop count of that route to 16. The unreachable route is then advertized to the router's neighboring routers
