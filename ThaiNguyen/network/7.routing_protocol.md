...
- Convergence: sau khi cac update packet được lan truyền khắp hệ thống mạng, tất cả các router sẽ có thông tin nhất quán trong routing table và topology table của chúng
