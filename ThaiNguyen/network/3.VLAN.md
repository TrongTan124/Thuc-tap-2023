...
- tăng khả năng bảo mật: bằng cách xếp người dùng vào các broadcast domain, VLANs giúp hạn chế việc các người dùng không được cấp phép truy cập vào hệ thống mạng bằng cách quản lý các giao tiếp từ bên ngoài vào VLAN
