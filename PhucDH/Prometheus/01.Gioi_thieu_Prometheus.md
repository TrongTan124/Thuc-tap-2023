...
- Để giải quyết vấn đề này, thì Pushgateway được ra đời. Pushgateway sẽ đóng vai trò trung gian giữa promethes server và targets cần monitor. Lúc này, metrics sẽ được phơi bày ở pushgateway, chứ không pải là ở targets nữa.
...
Có thể tham khảo cách cài đặt trong bài viết sau: <https://github.com/linhlt247/ghichep-prometheus/blob/master/2.Cai_dat_Prometheus.md>

<https://developers.soundcloud.com/blog/prometheus-monitoring-at-soundcloud>

<https://prometheus.io/docs/introduction/overview/>

<http://www.slideshare.net/brianbrazil/prometheus-a-next-generation-monitoring-system-fosdem-2016>
